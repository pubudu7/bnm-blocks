...
class DemoImporter {
    ...
    public function set_demo_page_setup( $location_data ) {
        ...
        register_importer( 'bnm-blocks-importer', 'Post Blocks & Tools Importer', 'Importer by ThemezHut', apply_filters( 'bnmbt_demo_page_display_callback_function', array( $this, 'display_demos' ) ) );
